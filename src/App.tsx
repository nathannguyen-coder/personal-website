...
const projects = [
  ...
  },
  {
    ...
    tags: ["FastAPI", "ChromaDB", "BM25 hybrid", "Ollama/Qwen", "Boundary gate"],
    theme: "governance",
  ...
  },
  {
    ...
    tags: ["FastAPI", "TypeScript", "React", "Nextflow", "Docker", "CLR analysis"],
    theme: "wastewater",
  ...
  },
  {
    ...
    tags: ["Python", "MySQL", "Power BI", "XGBoost"],
    theme: "market",
